...
try {
	...
	try {
		...
		console.dir(err)
		console.error("js-bson: Failed to load c++ bson extension, using pure JS version.AAAAAAAAAAAAAAA");
		throw new Error("js-bson: Failed to load c++ bson extension, using pure JS version.AAAAAAAAAAAAAAA");
	}
}
